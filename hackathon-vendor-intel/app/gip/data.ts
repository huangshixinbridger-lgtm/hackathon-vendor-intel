...
export const mockGIPRecords: GIPStrategyRecord[] = [
  ...
  {
    // —— DEMO：hero 游戏 Free Fire，端到端联动演示数据（非真实投放）——
    gameId: "freefire",
    game: "Free Fire",
    category: "Shooter",
    vendor: "Garena",
    ...
    budget: 240000,
    consumption: 213600,
    organic: { vv: 286200000, liveViewers: 18900000, creators: 52300, position: "头部" },
    activities: [
      {
        name: "BR Carnival Collab Burst",
        period: "2026-04",
        region: "BR",
        spend: 88000,
        posts: 690,
        vv: 52400000,
        creators: 168,
        interactions: 1834000,
        billingMode: "CPM",
        creatorTier: "Mid",
        contentAngle: "巴西嘉年华联动皮肤 + 名场面集锦",
        review: "BR 是 FF 第一大盘，联动节点 VV 爆发强，复投确定性高。",
      },
      {
        name: "ID Ramadan Live Push",
        period: "2026-05",
        region: "ID",
        spend: 61000,
        posts: 430,
        ...
        billingMode: "CPE",
        creatorTier: "Mid",
        contentAngle: "斋月活动直播任务 + 主播挑战",
        review: "ID 直播承接稳定，斋月节点适合做区域补供给。",
      },
    ],
  },
];
